    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <p class="mb-2"><strong>Fecha:</strong> <?= e(date('d/m/Y H:i', strtotime($order['fecha_pedido']))) ?></p>
                <p class="mb-2"><strong>Total:</strong> <?= e(format_price($order['total'])) ?></p>
                <a href="<?= e(app_url('mis-pedidos')) ?>" class="btn btn-outline-secondary">Volver a pedidos</a>
            </div>
        </div>
    </div>
</div>
